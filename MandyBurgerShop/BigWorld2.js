class BigWorld2 extends Phaser.Scene {
  constructor() {
    super({
      key: "BigWorld2",
    });
  ...
  preload() {
    // Step 1, load JSON
    this.load.tilemapTiledJSON("BigWorld2", "assets/BigWorld.tmj");
  ...
  this.anims.create({
    ...
    let map = this.make.tilemap({ key: "BigWorld2" });
    ...
    var spaceDown = this.input.keyboard.addKey('SPACE');
        ...
        key5Down.on('down', function(){
          console.log("Key 6 pressed");
            ...
            this.player = this.physics.add.sprite(1013, 354, 'gen');
  ...
  update() {
    ...
    if (
      ...
      this.EzraLettuceField();

  
  }
  }
  
  EzraLettuceField(player, tile) {
    console.log("EzraLettuceField function");
    this.scene.start("EzraLettuceField");
  }
  }
  /////////////////// end of create //////////////////////////////
