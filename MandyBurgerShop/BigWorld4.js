class BigWorld4 extends Phaser.Scene {
  constructor() {
    super({
      key: "BigWorld4",
    });
  ...
  preload() {
    // Step 1, load JSON
    this.load.tilemapTiledJSON("BigWorld4", "assets/BigWorld.tmj");
  ...
  this.anims.create({
    ...
    let map = this.make.tilemap({ key: "BigWorld4" });
    ...
    var spaceDown = this.input.keyboard.addKey('SPACE');
        ...
        key5Down.on('down', function(){
          console.log("Key 6 pressed");
            ...
            this.player = this.physics.add.sprite(302, 1115, 'gen');
