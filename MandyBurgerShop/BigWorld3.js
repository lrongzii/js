class BigWorld3 extends Phaser.Scene {
  constructor() {
    super({
      key: "BigWorld3",
    });
  ...
  preload() {
    // Step 1, load JSON
    this.load.tilemapTiledJSON("BigWorld3", "assets/BigWorld.tmj");
  ...
  this.anims.create({
    ...
    let map = this.make.tilemap({ key: "BigWorld3" });
    ...
    var spaceDown = this.input.keyboard.addKey('SPACE');
        ...
        key5Down.on('down', function(){
          console.log("Key 6 pressed");
            ...
            this.player = this.physics.add.sprite(851, 920, 'gen');
  ...
  BaileySpeech(player, tile) {
    console.log("BaileySpeech");
    this.scene.start("BaileySpeech");
  }
  }
  /////////////////// end of create //////////////////////////////
 /////////////////// end of update //////////////////////////////
